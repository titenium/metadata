            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-4 mb-30">
                    <div class="single-cta">
                        ...
                        <div class="cta-text">
                            <h4>Call us</h4>
                            <span><a href="tel:+91 8780227531">+91 8780227531</a></span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4 mb-30">
                    <div class="single-cta">
                        ...
                        <div class="cta-text">
                            <h4>Mail us</h4>
                            <span><a href="mailto:sachin.mict20@sot.pdpu.ac.in">sachin.mict20@sot.pdpu.ac.in</a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-4 col-lg-4 mb-50">
                    <div class="footer-widget">
                        ...
                        <div class="footer-social-icon">
                            ...
                            <a href="#" id="gmailBtn"><i class="fa fa-envelope-o"></i></a>
                        </div>
                    </div>
                </div>
